...
use Pingu\Core\Traits\Controllers\IndexesAdminModel;
use Pingu\Core\Traits\Controllers\PatchesAdminModel;
use Pingu\Core\Traits\Controllers\StoresAdminModel;
use Pingu\Core\Traits\Controllers\UpdatesAdminModel;
use Pingu\Forms\Contracts\Models\FormableContract;

abstract class AdminModelController extends ModelController
{	
	use EditsAdminModel, UpdatesAdminModel, CreatesAdminModel, StoresAdminModel, DeletesAdminModel, PatchesAdminModel, IndexesAdminModel;
